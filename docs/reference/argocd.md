---
title: ArgoCD guide
description: GitOps deployment examples and Secret patterns.
---

<div class="raw-document-actions" data-raw-path="/hermes-agent-helm/source/examples/argocd/README.md">
  <a href="/hermes-agent-helm/source/examples/argocd/README.md">Open raw Markdown</a>
