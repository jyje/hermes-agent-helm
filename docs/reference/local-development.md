...
[docs/reference/teams.md](teams.md)), set the allow-bots flag so agents can reply to
each other:
...
See [docs/reference/collaboration.md](collaboration.md) for the full multi-agent setup.
