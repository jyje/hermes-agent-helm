...
[Hermes teams](../advanced/teams/reference.md)), set the allow-bots flag so agents can reply to
each other:
...
See [Hermes collaboration](../advanced/teams/collaboration.md) for the full multi-agent setup.
