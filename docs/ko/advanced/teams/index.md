...
값, 라이브로 검증된 증거까지 원하신다면 [Hermes 팀](reference.md)과
[Hermes 협업](collaboration.md)을 참고하세요 - 이 페이지는 그
...
| 자세한 문서 | [collaboration.md](collaboration.md) | [teams.md](reference.md#리더-주도-팀-leader-orchestrated-teams) |
...
[collaboration.md](collaboration.md)에 있습니다.
...
[Hermes 팀](reference.md#리더-주도-팀-leader-orchestrated-teams)에 있습니다.
...
[collaboration.md § Discord 너머로](collaboration.md#discord-너머-telegram과-slack)
(페어)와 [teams.md § Telegram과 Slack](reference.md#telegram과-slack)
(리더 팀)에 있습니다.
...
[teams.md § 라이브 증거](reference.md#라이브-증거)에서 볼 수
있습니다.

## 다음으로 볼 것

- [Hermes 팀](reference.md) - 완전한 레퍼런스: "왜 단일 인스턴스인가"에
  대한 근거, 더 큰 명부를 위한 ArgoCD ApplicationSet 패턴, 전체 리더 팀
  프로토콜.
- [Hermes 협업](collaboration.md): 완전한 페어 레시피 - 혼합 모델
  백엔드, 파트너 ID를 어디에 둘지(선언적으로 vs. 대화 중 학습), 멀티 에이전트
  ApplicationSet 변형.
- [로드맵](../../about/roadmap.md): 두 팀 형태 모두에서 무엇이 증명됐고 무엇이
  아직 진행 중인지.
