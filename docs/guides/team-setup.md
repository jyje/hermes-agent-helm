...
live-verified evidence, see [Hermes teams](../reference/teams.md) and
[Hermes collaboration](../reference/collaboration.md) — this page exists to get
...
[collaboration.md](../reference/collaboration.md).
...
cluster — is in [Hermes teams](../reference/teams.md#leader-orchestrated-teams).
...
terminates. See [teams.md § Live evidence](../reference/teams.md#live-evidence)
for both Discord thread links and timings.

## Where to go from here

- [Hermes teams](../reference/teams.md) — the complete reference: the "why a
  single instance" rationale, the ArgoCD ApplicationSet pattern for larger
  rosters, and the full leader-team protocol.
- [Hermes collaboration](../reference/collaboration.md) — the complete pair
...
- [Roadmap](../reference/roadmap.md) — what's proven vs. still in progress
