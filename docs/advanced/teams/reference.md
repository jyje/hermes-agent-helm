...
[English](reference.md) · [한국어](../../../ko/advanced/teams/reference.md)
...
note in the [chart README](https://github.com/jyje/hermes-agent-helm/blob/main/charts/hermes-agent/README.md)):
...
- For **shared persistent knowledge** (vector indices or shared reference
  ...
  [`values-shared-knowledge.yaml`](https://github.com/jyje/hermes-agent-helm/blob/main/charts/hermes-agent/values-shared-knowledge.yaml)
...
> [Hermes collaboration](collaboration.md).
...
> above is the recommended approach. See the [Roadmap](../../about/roadmap.md)
...
- [Chart README](https://github.com/jyje/hermes-agent-helm/blob/main/charts/hermes-agent/README.md): full values table, the
  `replicaCount` single-writer rationale, and Discord/Telegram env vars.
- [Roadmap](../../about/roadmap.md): the ApplicationSet-based team pattern, and
