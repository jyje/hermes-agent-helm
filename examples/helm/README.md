...
```bash
helm show values oci://ghcr.io/jyje/hermes-agent-helm/hermes-agent --version 0.5.2
helm show readme oci://ghcr.io/jyje/hermes-agent-helm/hermes-agent --version 0.5.2
```
...
helm upgrade --install hermes-agent oci://ghcr.io/jyje/hermes-agent-helm/hermes-agent \
  --version 0.5.2 -n hermes-agent --create-namespace \
...
make package                      # -> dist/hermes-agent-0.5.2.tgz

# 2) login to ghcr (PAT needs write:packages)
echo "$GITHUB_TOKEN" | helm registry login ghcr.io -u jyje --password-stdin

# 3) push as an OCI artifact
helm push dist/hermes-agent-0.5.2.tgz oci://ghcr.io/jyje/hermes-agent-helm
#   -> ghcr.io/jyje/hermes-agent-helm/hermes-agent:0.5.2
