...
helm upgrade --install hermes-agent \
  oci://ghcr.io/jyje/hermes-agent-helm/hermes-agent --version 1.11.0 \
  --namespace hermes-agent --create-namespace \
  --set-string env.OPENAI_API_KEY='sk-...' --wait
...
```bash
helm show values oci://ghcr.io/jyje/hermes-agent-helm/hermes-agent --version 1.11.0
helm show readme oci://ghcr.io/jyje/hermes-agent-helm/hermes-agent --version 1.11.0
```
...
helm upgrade --install hermes-agent oci://ghcr.io/jyje/hermes-agent-helm/hermes-agent \
  --version 1.11.0 -n hermes-agent --create-namespace \
...
make package                      # -> dist/hermes-agent-1.11.0.tgz

# 2) login to ghcr (PAT needs write:packages)
echo "$GITHUB_TOKEN" | helm registry login ghcr.io -u jyje --password-stdin

# 3) push as an OCI artifact
helm push dist/hermes-agent-1.11.0.tgz oci://ghcr.io/jyje/hermes-agent-helm
#   -> ghcr.io/jyje/hermes-agent-helm/hermes-agent:1.11.0
