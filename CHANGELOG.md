...
- [#245](https://github.com/jyje/hermes-agent-helm/pull/245) [`252cfeb`](https://github.com/jyje/hermes-agent-helm/commit/252cfeb30d88aa379d917af298cad8289a5ce40a) - thanks [@jyje-bot](https://github.com/apps/jyje-bot)! - Update the default Hermes Agent image to v2026.8.27.
...
- 63b4e09: Feature(values): Add an opt-in NetworkPolicy blocking the cloud metadata endpoint
...
- 7e3caac: Feature(teams): Let config: override team mode's Discord defaults
...
- 3ee99df: Documentation(values): Add A2A (Agent-to-Agent) listener example

  Provide a copy-ready values overlay and README guidance for exposing
  Hermes' A2A listener through the chart's existing config.yaml passthrough
  and an explicit Service port.
