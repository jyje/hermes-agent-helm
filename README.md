...
- **Lightweight → production.** Sized for homelab / single-node / edge clusters
  ...
  [Hermes teams](https://jyje.github.io/hermes-agent-helm/reference/teams/).
...
<div align="center">
  ...
  <a href="https://jyje.github.io/hermes-agent-helm/reference/teams/">Hermes teams</a> for the current status.</em></p>
</div>
...
long-term, not-started candidate. See [Roadmap](https://jyje.github.io/hermes-agent-helm/reference/roadmap/).
