...
⚓ A community-powered, lightweight Helm chart to run **Hermes Agent** on Kubernetes as a StatefulSet
...
[![Kubernetes](https://img.shields.io/badge/Kubernetes-StatefulSet-326CE5?logo=kubernetes&logoColor=white)](https://kubernetes.io)
[![LLM](https://img.shields.io/badge/LLM-provider--agnostic-success)](#provider-agnostic)
[![Footprint](https://img.shields.io/badge/footprint-lightweight-brightgreen)](#lightweight)

[English](README.md) · [Chart docs](charts/hermes-agent/README.md) · [Contributing](AGENTS.md)
...
`hermes-helm` is a **community-powered** Helm chart that packages
...
charts/hermes-agent/values.example.yaml  # example overrides (in-cluster LiteLLM proxy on NFS storage)
...
# release name == chart name keeps resources clean (hermes-agent-0, not hermes-hermes-agent-0)
...
(git-cliff), and publishes the chart to `oci://ghcr.io/<owner>/charts` (GitHub
