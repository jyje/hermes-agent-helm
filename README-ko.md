...
[English](README.md) · [한국어](README-ko.md) · [日本語](README-ja.md) · [简体中文](README-zh.md) · **🚀 [Hermes 팀](docs/ko/advanced/teams/index.md)** · [Chart docs](charts/hermes-agent/README-ko.md) · [CONTRIBUTING](CONTRIBUTING.md) · [SECURITY](SECURITY-ko.md) · [AGENTS](AGENTS.md)
...
| 관심사 | 방법 | 검증 근거 |
|---|---|---|
| Pod Security Standards | `-f charts/hermes-agent/values-hardened.yaml` | hardened kind 시나리오 (PSS `restricted`) |
