...
helm upgrade --install hermes-agent \
  oci://ghcr.io/jyje/hermes-agent-helm/hermes-agent --version 1.16.0 \
...
A few more commonly-used ones, current as of image `v2026.9.24`:
