...
| --- | --- | --- |
| [`values.example.nvidia-nim-and-discord.yaml`](values.example.nvidia-nim-and-discord.yaml) | NVIDIA NIM | **Discord bot** wired in |
| [`values.example.openai.yaml`](values.example.openai.yaml) | OpenAI (`openai-api`) | — |
| [`values.example.anthropic.yaml`](values.example.anthropic.yaml) | Anthropic (Claude) | — |
| [`values.example.gemini.yaml`](values.example.gemini.yaml) | Google Gemini | — |
| [`values.example.openrouter.yaml`](values.example.openrouter.yaml) | OpenRouter | — |
